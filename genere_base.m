...
% fonction genere_base(reference,base,type_image_ref,type_image_base,N)
...
%   Créé 100 fichiers image mesurexxx.png et 100 fichiers textes 
%   mesurexxx.txt dans le répertoire appr. 
%   Les images crées sont construites à partir de formes initiales stockées 
%   dans le répertoire reference, et correspondent à des rotations et des 
%   homothéties aléatoires appliquées à ces formes, 
%   ainsi qu’à de petites déformations de celles-ci. 
